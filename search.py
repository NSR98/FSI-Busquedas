...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Nodos visitados: " + str(contador))
            print("Nodos expandidos: " + str(contador-1))
            return node
...
def ramification(problem):
    return graph_search(problem, calculateRamification())


"""Parte 2"""

def ramification_underestimated(problem):
    """Ordenación por el coste total acumulado y una heuristica"""
    return graph_search(problem, calculateRamificationUnderestimated(problem))
